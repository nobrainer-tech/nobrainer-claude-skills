---
name: wiki-get
description: Query the NoBrainer Wiki — answer a question by navigating index.md and grepping pages, synthesize with citations, optionally save the answer as a new page. Use when user says "wiki-get", "what do I know about", "ask the wiki", "check the wiki", "query wiki".
---
